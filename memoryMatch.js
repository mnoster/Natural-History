...
app.controller("appController", function ($timeout) {
    ...
    self.timesPlayed = 0;
    self.randomArr = [];
    self.bird_types = ['American Coot', "Anna\'s Hummingbird", "Double Crested Cormorant", "Dead Fish", "Great Blue Heron", "Mallard Duck", "Mourning Dove", "Pied-billed Grebe", "Wood Ducks",'American Coot', "Anna\'s Hummingbird", "Double Crested Comorant", "Dead Fish", "Great Blue Heron", "Mallard Duck", "Mourning Dove", "Pied-billed Grebe", "Wood Ducks"];
    self.imgArray = ['MemoryMatchPhotos/AmericanCoot.jpg', "MemoryMatchPhotos/Anna\'s Hummingbird.jpg", "MemoryMatchPhotos/double crested comorant.jpg", "MemoryMatchPhotos/fish.png", "MemoryMatchPhotos/great-blue-heron.jpg", "MemoryMatchPhotos/Mallard Duck.jpg", "MemoryMatchPhotos/mourning-dove.jpg", "MemoryMatchPhotos/PiedbilledGrebe.jpg", "MemoryMatchPhotos/wood-duck-pair.jpg",'MemoryMatchPhotos/AmericanCoot.jpg', "MemoryMatchPhotos/Anna\'s Hummingbird.jpg", "MemoryMatchPhotos/double crested comorant.jpg", "MemoryMatchPhotos/fish.png", "MemoryMatchPhotos/great-blue-heron.jpg", "MemoryMatchPhotos/Mallard Duck.jpg", "MemoryMatchPhotos/mourning-dove.jpg", "MemoryMatchPhotos/PiedbilledGrebe.jpg", "MemoryMatchPhotos/wood-duck-pair.jpg"];
